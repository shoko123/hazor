    ...
    <v-card-text>
      ...
      >
        <v-tab
          ...
          :key="index"
          color="purple"
          :class="cat.cnt > 0 ? 'has-selected' : ''"
        >
          {{ cat.cnt === 0 ? cat.catName : `${cat.catName}(*)` }}
        </v-tab>
      </v-tabs>
...
import ParamsAsChips from './ParamsAsChips2.vue'
import ParamsAsTextSearch from './ParamsAsTextSearch.vue'
import ParamsAsOrderBy from './ParamsAsOrderBy2.vue'
