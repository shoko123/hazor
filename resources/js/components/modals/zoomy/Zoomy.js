    ...
    transformByMouseEvent(e) {
        ...
        if (this.isDragging) {
            var newLeft = currentLeft + (currentMouseX - this.lastMouseX),
                ...
                heightInsideCanvas =
                    img.top >= box.top && img.bottom <= box.bottom,
                widthInsideCanvas =
        ...
        if (e.deltaY) {
            ...
            enlargeOrShrinkBy =
                (e.deltaY > 0 ? -zoomFactor : zoomFactor) * currentScale
                    ...
                    if (!heightFits) {
                        ...
                        if (newBottom < currentBottom) {
                            var newBottomDistance = box.bottom - newBottom,
                                movesUpTooMuch =
                                    newBottomDistance > visualMargin
