...
export const useRoutesPlanTransitionStore = defineStore('routesPlanTransition', () => {
    function planTransition(handle_to: RouteLocationNormalized, handle_from: RouteLocationNormalized): TPlanResponse {
        ...
        const to = { name: handle_to.name, module: <string>handle_to.params.module, slug: handle_to.params.slug }
        const from = { name: handle_from.name, module: <string>handle_from.params.module, slug: handle_from.params.slug }
